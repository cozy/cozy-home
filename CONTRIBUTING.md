...
$ cd cozy-collect
$ git remote add fork git://github.com/cozy/cozy-collect.git
```
...
Go to https://github.com/cozy/cozy-collect and select your branch. Click the 'Pull Request' button and fill out the form.
