...
throw new Error("Module parse failed: Unexpected token (9:7)\nYou may need an appropriate loader to handle this file type.\n| minilog.suggest.allow(`cozy-harvest`, 'info')\n| \n> export logger\n| ");
...
/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_38___default = /*#__PURE__*/__webpack_require__.n(_logger__WEBPACK_IMPORTED_MODULE_38__);
...
_logger__WEBPACK_IMPORTED_MODULE_38___default.a.info('Available konnector policies', policies);
var IDLE = 'IDLE';
var RUNNING = 'RUNNING';
...
var findKonnectorPolicy = function findKonnectorPolicy(konnector) {
  ...
  _logger__WEBPACK_IMPORTED_MODULE_38___default.a.info("Using ".concat(policy.name, " konnector policy for ").concat(konnector.slug));
  return policy;
};
/**
        ...
        switch (_context.prev = _context.next) {
          ...
          case 11:
            if (cipher && saveInVault) {
              ...
              _logger__WEBPACK_IMPORTED_MODULE_38___default.a.warn('No cipher passed when creating/updating account, account will not be linked to cipher');
            }
...
var KonnectorVaultUnlocker = function KonnectorVaultUnlocker(_ref3) {
  ...
  if (konnectorPolicy.saveInVault) {
    ...
    _logger__WEBPACK_IMPORTED_MODULE_38___default.a.info('Not rendering VaultUnlocker since konnectorPolicy.saveInVault = false');
...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(DumbTriggerManager, [{
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.prev = 5;
                _logger__WEBPACK_IMPORTED_MODULE_38___default.a.log('konnector policy', konnectorPolicy);
              ...
              case 14:
                // eslint-disable-next-line no-console
                _logger__WEBPACK_IMPORTED_MODULE_38___default.a.info('Bypassing cipher creation because of konnector account policy');
    ...
    value: function handleError(error) {
      _logger__WEBPACK_IMPORTED_MODULE_38___default.a.error('TriggerManager handleError', error);
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 14:
                ...
                // eslint-disable-next-line no-console
                _logger__WEBPACK_IMPORTED_MODULE_38___default.a.error("Error while getting decrypted ciphers for ".concat(konnector.slug, " konnector:")); // eslint-disable-next-line no-console

                _logger__WEBPACK_IMPORTED_MODULE_38___default.a.error(_context6.t0);
...
//# sourceMappingURL=vendors.bd600bc9ecbd2d487ee9.hot-update.js.map