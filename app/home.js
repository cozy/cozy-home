...
var useFetchShortcut = function useFetchShortcut(client, file) {
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])(),
      ...
      shortcurtImg = _useState4[0],
      setShotcutImg = _useState4[1];

  var _useState5 = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])('idle'),
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return client.getStackClient().fetchJSON('GET', "/shortcuts/".concat(file.id));
  ...
  return {
    ...
    shortcurtImg: shortcurtImg,
    fetchStatus: fetchStatus
  };
};

/* harmony default export */ __webpack_exports__["default"] = (useFetchShortcut);
...
const {
  folder
} = cozy_client__WEBPACK_IMPORTED_MODULE_1__["models"];
const {
  MAGIC_FOLDERS,
  ensureMagicFolder
} = folder;

const useHomeShortcuts = client => {
  const {
    t
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    const load = async () => {
      const {
        _id: dirId
      } = await ensureMagicFolder(client, MAGIC_FOLDERS.HOME, t('magic_folder_path'));
      const {
        data
...
/* harmony default export */ __webpack_exports__["default"] = (Object(cozy_client__WEBPACK_IMPORTED_MODULE_4__["withClient"])(LogoutButton));
...
/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var cozy_ui_react_Icon__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("y6ex");
/* harmony import */ var hooks_useFetchShortcut__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("5WiS");
...
var ShortcutTile = function ShortcutTile(_ref) {
  var client = _ref.client,
      file = _ref.file;
  var shortcut = Object(hooks_useFetchShortcut__WEBPACK_IMPORTED_MODULE_4__["default"])(client, file);
  var url = lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(shortcut, 'shortcutInfos.data.attributes.url', '#');
  var shortcurtImg = lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(file, 'metadata.icon');
  var label = file.name.substr(0, file.name.lastIndexOf('.'));

  var _useBreakpoints = Object(cozy_ui_transpiled_react__WEBPACK_IMPORTED_MODULE_5__["useBreakpoints"])(),
      isMobile = _useBreakpoints.isMobile;
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
    ...
    className: "item-icon"
  }, shortcurtImg ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
    src: "data:image/svg+xml;base64,".concat(btoa(shortcurtImg)),
    width: "100%",
    alt: ""
  }) : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(cozy_ui_react_Icon__WEBPACK_IMPORTED_MODULE_3__["default"], {
    icon: "device-browser",
...
/* harmony default export */ __webpack_exports__["default"] = (Object(cozy_client__WEBPACK_IMPORTED_MODULE_1__["withClient"])(ShortcutTile));
...
var HeroHeader = function HeroHeader(_ref) {
  ...
  var showLogout = cozy_flags__WEBPACK_IMPORTED_MODULE_6___default()('home.corner.logout-is-displayed') === null ? true : cozy_flags__WEBPACK_IMPORTED_MODULE_6___default()('home.corner.logout-is-displayed');
  var showSettings = cozy_flags__WEBPACK_IMPORTED_MODULE_6___default()('home.corner.settings-is-displayed') === null ? false : cozy_flags__WEBPACK_IMPORTED_MODULE_6___default()('home.corner.settings-is-displayed');
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("header", {
    ...
    className: "corner"
  }, showLogout && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_LogoutButton__WEBPACK_IMPORTED_MODULE_7__["default"], null), showSettings && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_SettingsButton__WEBPACK_IMPORTED_MODULE_8__["default"], null)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
...
/* harmony import */ var components_ShortcutTile__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("hxBG");
/* harmony import */ var components_LoadingPlaceholder__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("gpBY");
...
/* harmony import */ var hooks_useHomeShortcuts__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("QFQr");
...
var LoadingAppTiles = Object(react__WEBPACK_IMPORTED_MODULE_0__["memo"])(function (_ref) {
  ...
  for (var i = 0; i < num; i++) {
    tiles.push(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      ...
      className: "item-icon"
    }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(components_LoadingPlaceholder__WEBPACK_IMPORTED_MODULE_6__["default"], null))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", {
      className: "item-title"
    }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(components_LoadingPlaceholder__WEBPACK_IMPORTED_MODULE_6__["default"], null))));
  }
...
var Applications = Object(react__WEBPACK_IMPORTED_MODULE_0__["memo"])(function (_ref2) {
  var receiveApps = _ref2.receiveApps,
      client = _ref2.client;
  var files = Object(hooks_useHomeShortcuts__WEBPACK_IMPORTED_MODULE_9__["default"])(client);
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    if (fetchStatus !== 'loaded') return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(LoadingAppTiles, {
      num: "3"
    });
    var apps = data.filter(function (app) {
      return app.state !== 'hidden' && !config_collect__WEBPACK_IMPORTED_MODULE_7__.filteredApps.includes(app.slug) && !cozy_flags__WEBPACK_IMPORTED_MODULE_3___default()("home_hidden_apps.".concat(app.slug.toLowerCase()));
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(components_ShortcutTile__WEBPACK_IMPORTED_MODULE_5__["default"], {
      key: index,
      file: file
    });
  }));
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(null, mapDispatchToProps)(Object(cozy_client__WEBPACK_IMPORTED_MODULE_2__["withClient"])(Applications)));
