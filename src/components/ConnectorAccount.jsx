...
export const ConnectorAccount = ({ t, connector, account, fields, editing, disableSuccessTimeout, oAuthTerminated, isUnloading, submitting, deleting, error, onDelete, onSubmit, onCancel }) => {
...
export default translate()(ConnectorAccount)
