...
/* ESM import */var node_fetch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./node_modules/node-fetch/lib/index.mjs");
...
/* ESM import */var url__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(url__WEBPACK_IMPORTED_MODULE_2__);
 ...
 */ const polyfillFetch = ()=>{
    if (global) {
        if (!global.fetch) global.fetch = node_fetch__WEBPACK_IMPORTED_MODULE_0__["default"];
        if (!global.Headers) global.Headers = node_fetch__WEBPACK_IMPORTED_MODULE_0__["default"].Headers;
        if (!global.Response) global.Response = node_fetch__WEBPACK_IMPORTED_MODULE_0__["default"].Response;
        if (!global.Request) global.Request = node_fetch__WEBPACK_IMPORTED_MODULE_0__["default"].Request;
        if (!global.FormData) global.FormData = (form_data__WEBPACK_IMPORTED_MODULE_1___default());
        if (!global.URL) global.URL = url__WEBPACK_IMPORTED_MODULE_2__.URL;
    }
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* ESM import */var _polyfillFetch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/targets/services/polyfillFetch.js");
/* ESM import */var node_fetch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./node_modules/node-fetch/lib/index.mjs");
/* ESM import */var form_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./node_modules/form-data/lib/form_data.js");
/* ESM import */var form_data__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(form_data__WEBPACK_IMPORTED_MODULE_2__);
/* ESM import */var url__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("url");
/* ESM import */var url__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(url__WEBPACK_IMPORTED_MODULE_3__);
/**
...
describe('polyfillFetch', ()=>{
    ...
    it('Should use global if exist or fallback to polyfill', ()=>{
        ...
        (0,_polyfillFetch__WEBPACK_IMPORTED_MODULE_0__["default"])();
        expect(global.fetch).toBe(shouldCheckFetchPolyfill ? node_fetch__WEBPACK_IMPORTED_MODULE_1__["default"] : global.fetch);
        expect(global.Headers).toBe(shouldCheckHeadersPolyfill ? node_fetch__WEBPACK_IMPORTED_MODULE_1__["default"].Headers : global.Headers);
        expect(global.Response).toBe(shouldCheckResponsePolyfill ? node_fetch__WEBPACK_IMPORTED_MODULE_1__["default"].Response : global.Response);
        expect(global.Request).toBe(shouldCheckRequestPolyfill ? node_fetch__WEBPACK_IMPORTED_MODULE_1__["default"].Request : global.Request);
        expect(global.FormData).toBe(shouldCheckFormDataPolyfill ? (form_data__WEBPACK_IMPORTED_MODULE_2___default()) : global.FormData);
        expect(global.URL).toBe(shouldCheckURLPolyfill ? url__WEBPACK_IMPORTED_MODULE_3__.URL : global.URL);
    });
    it('should use polyfill if global.fetch is not defined', ()=>{
        ...
        (0,_polyfillFetch__WEBPACK_IMPORTED_MODULE_0__["default"])();
        expect(global.fetch).toBe(node_fetch__WEBPACK_IMPORTED_MODULE_1__["default"]);
    });
});
